...
export default function RefundPolicy() {
  return (
    <>
      <SEO title="Refund Policy" description="azure-artsfoundation refund policy." pathname="/refund-policy" />
      <div className="container-main py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none text-gray-600">
            ...
            <p className="mb-4">Email admin@azure-artsfoundation.org with your order number and a short description of the problem. Our team responds within 2 business days.</p>
            ...
            <p>Questions? Email admin@azure-artsfoundation.org.</p>
          </div>
        </div>
      </div>
    </>
